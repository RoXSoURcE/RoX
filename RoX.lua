...
--   This Is The Source Channel @rox_source .   --
--                - RoX -                 --
--        -- https://t.me/zz --         --
------------------------------------------------ 
...
--     Source RoX     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then RoXSoURcE  = "المطور" elseif AbsSudo(msg) then RoXSoURcE = "المطور" elseif SecondSudo(msg) then RoXSoURcE = "المطور" elseif SudoBot(msg) then RoXSoURcE = "المطور" elseif Manager(msg) then RoXSoURcE = "المدير" elseif Admin(msg) then RoXSoURcE = "الادمن" else RoXSoURcE = "العضو" end return RoXSoURcE end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1874628385) then RoXSoURcE = 'مطور السورس' elseif tonumber(user_id) == tonumber(782717203) then RoXSoURcE = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(RoX) then RoXSoURcE = 'البوت' elseif SudoId(user_id) then RoXSoURcE = 'المطور الاساسي' elseif DevAbs:sismember(RoX..'Abs:AbsSudo:', user_id) then RoXSoURcE = 'المطور الاساسي' elseif DevAbs:sismember(RoX..'Abs:SecondSudo:', user_id) then RoXSoURcE = 'المطور الاساسي²' elseif DevAbs:sismember(RoX..'Abs:SudoBot:', user_id) then RoXSoURcE = DevAbs:get(RoX.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(RoX..'Abs:AbsConstructor:'..chat_id, user_id) then RoXSoURcE = 'المالك' elseif DevAbs:sismember(RoX..'Abs:BasicConstructor:'..chat_id, user_id) then RoXSoURcE = DevAbs:get(RoX.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(RoX..'Abs:Constructor:'..chat_id, user_id) then RoXSoURcE = DevAbs:get(RoX.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(RoX..'Abs:Managers:'..chat_id, user_id) then RoXSoURcE = DevAbs:get(RoX.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(RoX..'Abs:Admins:'..chat_id, user_id) then RoXSoURcE = DevAbs:get(RoX.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(RoX..'Abs:VipMem:'..chat_id, user_id) then  RoXSoURcE = DevAbs:get(RoX.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(RoX..'Abs:Cleaner:'..chat_id, user_id) then  RoXSoURcE = DevAbs:get(RoX.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else RoXSoURcE = DevAbs:get(RoX.."Abs:mem:Rd"..chat_id) or 'العضو' end return RoXSoURcE end
--     Source RoX     --
...
local UserName = (dp.username_ or "rox_source")
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'rox_source')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_Abs..' ❩ بنجاح', 1, 'md')
...
if mrAbs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'rox_source')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "rox_source")}},
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "rox_source")..')', 1, 'md') 
...
local RoXSoURcE = '᥀︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, RoXSoURcE, 14, string.len(msg.sender_user_id_))
...
local RoXSoURcE = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Abs(msg.chat_id_, msg.id_, 1, ''..RoXSoURcE[math.random(#RoXSoURcE)]..'' , 1, 'md')  
return false
end
--     Source RoX     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or rox_source}}}
...
{{text = '᥀ RoX Team .', url="t.me/rox_source"}},
...
local RoXSoURcE =  DevAbs:smembers(RoX..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..RoXSoURcE[math.random(#RoXSoURcE)]..']' , 1, 'md')  
end
end
--     Source RoX     --
...
function RoXSoURcE(extra,result,success)
...
getUser(msg.sender_user_id_, RoXSoURcE)
end
end
--     Source RoX     --
text = msg.content_.text_
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@rox_source]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@rox_source]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source RoX     --
--        Contact         --
...
if DevAbs:get('RoXSoURcE:'..RoX.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('RoXSoURcE:'..RoX..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevAbs:del('RoXSoURcE:'..RoX.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('RoXSoURcE:'..RoX.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('RoXSoURcE:'..RoX..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('RoXSoURcE:'..RoX.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('RoXSoURcE:'..RoX..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevAbs:del('RoXSoURcE:'..RoX.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('RoXSoURcE:'..RoX.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('RoXSoURcE:'..RoX..'ids:user'..msg.chat_id_)  
...
--     Source RoX     --
if text == "الرابط" then
if not DevRio:get(RoX..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(RoX.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(RoX.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
if text == "الرابط" then
if not DevRio:get(RoX.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(RoX.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevAbs:get(RoX..'Abs:NameBot') or 'روكس')
local RoXSoURcE = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevAbs2 = math.random(#RoXSoURcE) 
Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE[DevAbs2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(RoX..'Abs:NameBot') or 'روكس') 
local RoXSoURcE = {"اسمي القميل "..NameBot.." "} 
DevAbs2 = math.random(#RoXSoURcE) 
Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE[DevAbs2] , 1, 'html') 
return false
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
RoXSoURcE = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
...
RoXSoURcE = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
...
RoXSoURcE = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
if text == DevAbs:get(RoX..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(RoX..'Abs:Games:Ids'..msg.chat_id_) then
...
RoXSoURcE = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
if text == DevAbs:get(RoX..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(RoX..'Abs:Games:Ids'..msg.chat_id_) then
...
RoXSoURcE = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
RoXSoURcE = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
...
RoXSoURcE = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
...
RoXSoURcE = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md')
return false
end end
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),RoXSoURcE)
end
end
--     Source RoX     --
...
local RoXSoURcE = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md') 
local RoXSoURcE = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..RoXSoURcE[math.random(#RoXSoURcE)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,RoXSoURcE)
end
end
--     Source RoX     --
...
local RoXSoURcE = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md') 
local RoXSoURcE = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..RoXSoURcE[math.random(#RoXSoURcE)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local RoXSoURcE = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md') 
local RoXSoURcE = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..RoXSoURcE[math.random(#RoXSoURcE)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local RoXSoURcE = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md') 
local RoXSoURcE = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..RoXSoURcE[math.random(#RoXSoURcE)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local RoXSoURcE = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,RoXSoURcE, 1, 'md') 
local RoXSoURcE = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..RoXSoURcE[math.random(#RoXSoURcE)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
RoXSoURcE = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,RoXSoURcE[math.random(#RoXSoURcE)])
end
--     Source RoX     --
...
DevAbs:set('RoXSoURcE:'..RoX..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('RoXSoURcE:'..RoX.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('RoXSoURcE:'..RoX..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('RoXSoURcE:'..RoX.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set("RoX:New:id:"..RoX..msg.sender_user_id_,'RoXSoURcE')
return "RoXSoURcE"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevAbs:set("RoX:New:id:"..RoX..msg.chat_id_..msg.sender_user_id_,'RoXSoURcE')
return "RoXSoURcE"
end
...
function RoXSoURcE(extra,Abs,success)
...
DevRio:setex(RoX.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(RoX.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(RoX.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
if text == "الروابط" then if DevAbs:get(RoX..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(RoX..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(RoX..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(RoX..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الصور" then if DevAbs:get(RoX..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(RoX..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(RoX..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(RoX..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(RoX..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(RoX..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(RoX..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(RoX..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(RoX..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(RoX..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "التعديل" then if DevAbs:get(RoX..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(RoX..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(RoX..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(RoX..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الدخول" then if DevAbs:get(RoX..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local RoXSoURcE = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(RoX..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "المواقع" then if DevAbs:get(RoX..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "العربيه" then if DevAbs:get(RoX..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(RoX..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local RoXSoURcE = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الكفر" then if DevAbs:get(RoX..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local RoXSoURcE = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الفشار" then if DevAbs:get(RoX..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local RoXSoURcE = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(RoX..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local RoXSoURcE = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, RoXSoURcE, 1, 'md') end
end
--     Source RoX     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/rox_source' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "rox_source")..")"
else 
...
if Admin(msg) then
local RoXTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل جلب رابط انلاين المجموعه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, RoXTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(RoX.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, RoXTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(RoX.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help0'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help01'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help21'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help31'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help41'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help51'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local RoXSoURcE =  DevAbs:get(RoX..'Abs:Help61'..msg.sender_user_id_)
if RoXSoURcE == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/rox_source"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/rox_source&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ مبرمج السورس',url="t.me/BBB43"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/rox_source&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
